fetch("JSON/acercaDeDatos.json")
  ...
  .then(data => {
    ...
    data.forEach(persona => {
      ...
      card.classList.add("bg-white", "rounded-lg", "shadow-2xl", "overflow-hidden", "hover:shadow-xl", "transition-shadow", "duration-300", "flex", "flex-col", "border-2", "border-black");
      ...
      card.innerHTML = `
        ...
        <div class="bg-gray-300 px-6 py-4">
          ...
          <p class="text-sm text-gray-600"><strong>Correo:</strong> <a href="mailto:${persona.correo}" class="text-blue-600 hover:text-blue-800">${persona.correo}</a></p>
        </div>
      ...
      // Clonar el template de iconos y agregarlo a la tarjeta
